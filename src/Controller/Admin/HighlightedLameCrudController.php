 ...
 */
class HighlightedLameCrudController extends AbstractLockableCrudController
{
    /**
    ...
    {
        $highligthed = $this->translator->trans('content.highlighted');
        ...
        return $crud
            ...
            ->setPageTitle(Crud::PAGE_NEW, ucfirst($this->translator->trans('bo.add')) . ' ' . $highligthed)
            ->setPageTitle(Crud::PAGE_EDIT, ucfirst($this->translator->trans('bo.edit')) . ' ' . $highligthed);
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if ($pageName === Crud::PAGE_NEW || $pageName === Crud::PAGE_EDIT) {
            ...
            $fields[] = AssociationField::new('dataset', ucfirst($this->translator->trans('content.dataset')));
        }
        return $fields;
    }
}
