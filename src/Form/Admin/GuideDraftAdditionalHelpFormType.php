...
/**
 * Associate an AdditionalHelp to a GuideDraft.
 * So, form used GuideDraft side.
 */
class GuideDraftAdditionalHelpFormType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults(
                [
                    'data_class' => AdditionalHelpGuideDraft::class,
                ]
            );
    }
}
