...
use App\Repository\DataWorkshopTranslationRepository;
use Doctrine\ORM\Mapping as ORM;
use Knp\DoctrineBehaviors\Contract\Entity\TranslationInterface;
use Knp\DoctrineBehaviors\Model\Translatable\TranslationTrait;

/**
 * @ORM\Entity(repositoryClass=DataWorkshopTranslationRepository::class)
 */
class DataWorkshopTranslation implements TranslationInterface
{
