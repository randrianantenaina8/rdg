...
CKEDITOR.dialog.add( 'image2', function( editor ) {
	...
	function onChangeSrc() {
		...
		if ( value !== widget.data.src ) {
			...
			preLoader( value, function( image, width, height, alt ) {
		...
		contents: [
			{
				...
				elements: [
					...
					},
					{
						...
						validate: editor.config.image2_tooltipRequired === true ? CKEDITOR.dialog.validate.notEmpty( lang.tooltipMissing ) : null
					},
					{
						id: 'link',
						type: 'text',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								commit: function( widget ) {
									widget.setData( 'borderColor', this.getValue() );
								}
							},
						]
						...
						children:[
							{
								...
								setup: function( widget ) {
									this.setValue( widget.data.marginV );
								},
								commit: function( widget ) {
									widget.setData( 'marginV', this.getValue() );
								}
							},
							{
								type: 'text',
								...
								setup: function( widget ) {
									this.setValue( widget.data.marginH );
								},
								commit: function( widget ) {
									widget.setData( 'marginH', this.getValue() );
								}
							},
						]
					},
