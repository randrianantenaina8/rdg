 ...
 */
final class Version20230921084827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logigram (id INT AUTO_INCREMENT NOT NULL, updated_by INT DEFAULT NULL, route_type VARCHAR(250) DEFAULT NULL, target_slug VARCHAR(250) DEFAULT NULL, is_published TINYINT(1) NOT NULL, INDEX IDX_A02A48C816FE72E1 (updated_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE logigramTranslation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, slug VARCHAR(510) NOT NULL, title VARCHAR(255) NOT NULL, sub_title LONGTEXT NOT NULL, locale VARCHAR(5) NOT NULL, UNIQUE INDEX UNIQ_1960AF68989D9B62 (slug), INDEX IDX_1960AF682C2AC5D3 (translatable_id), UNIQUE INDEX logigramTranslation_unique_translation (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
